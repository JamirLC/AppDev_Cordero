...
<body>
    <div>
        ...
        if ($_POST) {
            try {
                $query = "UPDATE products SET name=:name, description=:description, price=:price, quantity=:quantity, update_at=:update_at WHERE ID= :id";
                $stmt = $con->prepare($query);
                ...
                $stmt->bindParam("update_at", $updated);
